...
export default async function HomePage() {
  ...
  const sections = profile.themeSettings?.sectionVisibility || {
    showHero: true,
    showProjects: true,
    showExperience: true,
    showSkills: true,
  ...
  const content = profile.themeSettings?.sectionContent || {};

  return (
    <div className="space-y-12">
      {/* 1. Hero Section */}
      {sections.showHero !== false && <HeroSection profile={profile} />}
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl sm:text-4xl font-black text-white tracking-tight">
                  {content.projectsTitle || "Featured Mobile Projects"}
                </h2>
